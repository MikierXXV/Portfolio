            ...
            <section id="about">
                <div className="row">
                    <div className="nine columns main-col">
                        ...
                        <hr/>
                        <p style={{color: "whitesmoke"}}>{resumeData.aboutme}</p>
                        ...
                        <hr/>
                        <p style={{color: "whitesmoke"}}>{resumeData.roleDescription}</p>
                        <div className="penta">
                            <a href={"#about"}><i className={"fa-3x"}><FaBasketballBall/></i></a>
                            <a href={"#about"}><i className={"fa-3x"}><FaFilm/></i></a>
                            <a href={"#about"}><i className={"fa-3x"}><FaGuitar/></i></a>
                            <a href={"#about"}><i className={"fa-3x"}><GiBookshelf/></i></a>
                            <a href={"#about"}><i className={"fa-3x"}><FaLaptopCode/></i></a>
                        </div>
                    </div>
